...
const formTitle = computed(() =>
    isEditMode.value ? 'Kategori Güncelle' : 'Yeni Kategori',
);
...
<template>
    <aside
        class="rounded-3xl border border-primary-100 bg-white shadow-sm lg:max-w-md"
    >
        <header class="border-b border-neutral-100 px-6 py-6">
            ...
            <p class="mt-2 text-sm text-neutral-500 leading-relaxed">
                Kategorileri yönetebilir, isim, açıklama ve durumlarını güncelleyebilirsiniz.
            </p>
        </header>
